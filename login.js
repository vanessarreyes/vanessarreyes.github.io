function openModal() {
	...
	myInput.onkeyup = function() {
       ...
       console.log(letter.classList);
         ...
         */
         ...
         /* classList is --> The classList property returns the class name(s) of an element, as a DOMTokenList object
                            This property is useful to add, remove and toggle CSS classes on an element
                            */

        // Validate lowercase letters
        // if true --> make class valid
        if(myInput.value.match(lowerCaseLetters)) {
            // remove the invalid class
            letter.classList.remove("invalid");
            // add the valid class
            letter.classList.add("valid");
        // if false --> make class invalid
        } else {
            // remove valid class
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var input_psw = myInput.value, input_check = confirmMyInput.value;
                // variable that holds T/F if strings are equal
                var passEqualsConfPass = (input_psw == input_check); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
                // if true --> add valid class
...
function enableButton(letter, capital, number, length, match) {
    ...
    // var checks if all requirements have class of valid
